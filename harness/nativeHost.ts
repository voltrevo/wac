...
// of them once per *test* — `native_hostfs` seven times, `native_shell` and
// `arrival` three each — so a suite run spent tens of seconds asking a question whose answer had
// not changed. In the arrival test it was 2.5s of every one of the three tests,
