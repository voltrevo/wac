...
const NAMED: [string, number][] = [
  ...
  ["FAULT_NAME_TOO_LONG", FAULT_NAME_TOO_LONG],
  ["FAULT_LOOP", FAULT_LOOP],
  ["FAULT_NO_SPACE", FAULT_NO_SPACE],
  ["FAULT_REFUSED", FAULT_REFUSED],
  ["FAULT_UNREACHABLE", FAULT_UNREACHABLE],
  ["FAULT_TIMED_OUT", FAULT_TIMED_OUT],
];
