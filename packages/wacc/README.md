...
| type check | 282 of 304 spec rejections, 366 of 367 acceptances |
...
It reads **54 cases**: the reference meets all of them and wacc meets 53, the one left being half fixed and named. It held two misses for one slot — an
...
|---|---|---|
| `specSingle.test.ts` | the 671 one-file programs the suite **runs** | **the contract** — 282 of 304 illegal refused, 366 of 367 legal silent, the rest named |
