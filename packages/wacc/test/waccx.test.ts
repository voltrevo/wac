...
Deno.test("how many of wacc's diagnostics carry their operands", async () => {
  ...
  // 79/42/59, and on 2026-08-15 help reached 46 (six more codes got a hint that says something
  // the message does not) and the span 66 (`undefined type`, the largest spanless group at 47 of
  // 264, reports at its token). The floors are a few points under, so ordinary movement does
