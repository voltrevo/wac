...
Today, give or take whatever landed this morning: **38 packages, 122,072 lines of wac, 2,228
tests written in wac, 75 command-line programs and 11 browser pages.** Those are MAP.md's own
figures, copied on 2026-08-17 — the previous set said 32 packages and ~1,300 tests, which was
