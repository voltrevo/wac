...
// `test/wac/mlkem_test.wac`, which drives WebCrypto through `test/mlkem_oracle.ts` as a
// subprocess — Deno rather than Node, because only Deno's WebCrypto has ML-KEM here.
//
