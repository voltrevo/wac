...
> Landed 2026-08-08, and it had not existed until then: `wac task corpus:backings` runs all 817 of
...
- **Where the native runtime lives.** Still an operator decision, now **taken provisionally** because
  ...
  arguments against stand — cargo is a second build system and `wac task test` reaches it only by
