...
// The sizes go in a generated file for the same reason the package table's numbers do: a figure
// typed into a component is right on the day it is typed and wrong after the next rebuild.
await Deno.writeTextFile(
  new URL("../src/data/demos.ts", import.meta.url).pathname,
  `// Generated by tools/syncDemos.ts. Do not edit — rerun it.\n` +
    `export const DEMO_SIZES: Record<string, string> = ${JSON.stringify(
