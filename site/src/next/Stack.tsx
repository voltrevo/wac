      ...
      <Section id="wacc" kicker="hard to fake, #4" title="The compiler, being rewritten in the language it compiles">
        ...
        <Table
          ...
          rows={[
            ...
            [<span style={{ fontFamily: font.mono }}>emitter</span>, "both modules run and answer the same", <span style={{ color: c.warm }}>400 of 403 files, 0 invalid</span>],
        ...
        <P>
          It is nearly finished — the emitter compiles <Lead>400 of the repository&rsquo;s 403 wac
          ...
          And <em>none of the 400 produces an invalid module</em>, which is the property that had to
