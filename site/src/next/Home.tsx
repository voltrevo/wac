    ...
    <Page current="home" contents={false}>
      ...
      <Section id="wacc" kicker="one of them, in full" title="The compiler, written in wac">
        ...
        <P>
          ...
          361 files</Lead>, a Tor relay and an SSH server and the compiler itself, with no false
        ...
        <Caveat title="not finished">
          The emitter compiles <Lead>358 of the repository&rsquo;s 361 wac files</Lead> whole, and
          ...
          does not supply. None of the 361 produces an invalid module, and — since
          ...
          the emitter&rsquo;s word — none of the 358 is missing one either. That is the
