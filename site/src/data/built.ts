...
export const TOTALS = {
  ...
  pages: 11,
  /**
   * The whole repository: the packages (2494), and the compiler, harness and tooling
   * around them (1401).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "crypto", what: "The hashes, AEADs, curves and one KEM the rest of this repo is built on — written in wac, calling nothing.", lines: 5890, tests: 275 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 29751, tests: 218 },
  ...
  { name: "wacpkg", what: "Where a wac project says its dependencies come from: wac.json5, read and checked.", lines: 1139, tests: 34 },
