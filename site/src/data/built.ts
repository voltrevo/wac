...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 6157, tests: 219 },
  { name: "rlp", what: "Recursive Length Prefix — the Ethereum execution layer's serialisation, in wac.", lines: 317, tests: 10 },
  { name: "crypto", what: "The hashes, AEADs, curves and one KEM the rest of this repo is built on — written in wac, calling nothing.", lines: 5890, tests: 279 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 31031, tests: 248 },
  { name: "wactest", what: "Assertions for tests written in wac.", lines: 1171, tests: 28 },
