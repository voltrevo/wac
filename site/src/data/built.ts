...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "http", what: "HTTP/1.1: parsing requests and responses, and writing both.", lines: 914, tests: 29 },
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 3291, tests: 100 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 3828, tests: 14 },
  { name: "zstd", what: "Zstandard (RFC 8878) in wac.", lines: 2690, tests: 42 },
  { name: "crypto", what: "SHA-256, SHA-512/384, SHA-3, SHAKE, HMAC, HKDF, bcrypt_pbkdf, ChaCha20-Poly1305, AES-CTR, AES-GCM, X25519, Ed25519, NIST P-256 and P-384, RSA…", lines: 5522, tests: 144 },
  ...
  { name: "sh", what: "A shell, in wac.", lines: 6611, tests: 31 },
  ...
  { name: "box", what: "60 applets in one program, chosen by the first argument.", lines: 4006, tests: 33 },
  { name: "lightclient", what: "The Altair sync protocol works.", lines: 642, tests: 12 },
  { name: "ssh", what: "An SSH-2 client and server, in wac, and ssh and sshd programs built from them.", lines: 3571, tests: 46 },
  { name: "tor", what: "A Tor client, in wac, on top of this repo's TLS 1.3 stack.", lines: 12086, tests: 207 },
];
