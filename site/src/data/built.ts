...
export const TOTALS = {
  ...
  pages: 11,
  /**
   * The whole repository: the packages (2341), and the compiler, harness and tooling
   * around them (1390).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "zstd", what: "Zstandard (RFC 8878) in wac.", lines: 3033, tests: 63 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 29505, tests: 211 },
  ...
  { name: "wacpkg", what: "Where a wac project says its dependencies come from: wac.json5, read and checked.", lines: 852, tests: 24 },
