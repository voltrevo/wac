...
export const TOTALS = {
  ...
  pages: 11,
  /**
   * The whole repository: the packages (2538), and the compiler, harness and tooling
   * around them (1389).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 4213, tests: 220 },
  ...
  { name: "wactest", what: "Assertions for tests written in wac.", lines: 1568, tests: 28 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 33577, tests: 260 },
