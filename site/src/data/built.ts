...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "crypto", what: "The hashes, AEADs, curves and one KEM the rest of this repo is built on — written in wac, calling nothing.", lines: 6315, tests: 283 },
  ...
  { name: "wactest", what: "Assertions for tests written in wac.", lines: 1624, tests: 28 },
