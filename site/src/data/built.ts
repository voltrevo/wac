...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 29875, tests: 225 },
  { name: "wactest", what: "Assertions for tests written in wac.", lines: 730, tests: 23 },
  ...
  { name: "wacpkg", what: "Where a wac project says its dependencies come from: wac.json5, read and checked.", lines: 1599, tests: 42 },
];
