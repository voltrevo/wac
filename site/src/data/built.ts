...
export const TOTALS = {
  ...
  pages: 5,
  /**
   * The whole repository: the packages (1671), and the compiler, harness and tooling
   * around them (1329).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 18080, tests: 92 },
  ...
  { name: "git", what: "git's object database, in wac.", lines: 334, tests: 6 },
  ...
  { name: "sh", what: "A shell, in wac, whose definition of correct is GNU bash: a corpus of scripts runs through both and the two must agree on standard output…", lines: 7071, tests: 30 },
  ...
  { name: "box", what: "65 applets in one program, chosen by the first argument — 64 tools and help, which prints the list.", lines: 8129, tests: 122 },
  ...
  { name: "ssh", what: "An SSH-2 client and server, in wac, and ssh and sshd programs built from them.", lines: 4057, tests: 56 },
];
