...
export const TOTALS = {
  ...
  pages: 11,
  /**
   * The whole repository: the packages (2351), and the compiler, harness and tooling
   * around them (1391).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 6090, tests: 216 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 29637, tests: 214 },
