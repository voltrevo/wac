...
export const TOTALS = {
  ...
  pages: 9,
  /**
   * The whole repository: the packages (1932), and the compiler, harness and tooling
   * around them (1347).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "quic", what: "QUIC version 1 — RFC 9000 and RFC 9001 — in wac.", lines: 2932, tests: 76 },
