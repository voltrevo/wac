...
export const TOTALS = {
  ...
  pages: 11,
  /**
   * The whole repository: the packages (2537), and the compiler, harness and tooling
   * around them (1390).
   *
...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 6157, tests: 220 },
  { name: "rlp", what: "Recursive Length Prefix — the Ethereum execution layer's serialisation, in wac.", lines: 317, tests: 10 },
  { name: "crypto", what: "The hashes, AEADs, curves and one KEM the rest of this repo is built on — written in wac, calling nothing.", lines: 5957, tests: 283 },
  ...
  { name: "wactest", what: "Assertions for tests written in wac.", lines: 1367, tests: 28 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 31296, tests: 259 },
  { name: "wacpkg", what: "Where a wac project says its dependencies come from: wac.json5, read and checked.", lines: 1599, tests: 44 },
];
