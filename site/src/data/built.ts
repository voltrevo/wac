...
export const BUILT: BuiltPackage[] = [
  ...
  { name: "platform", what: "A capability world for wac applications, so a program can be written entirely in wac — no TypeScript of its own — and still read files, tell…", lines: 4923, tests: 165 },
  ...
  { name: "quic", what: "QUIC version 1 — RFC 9000 and RFC 9001 — in wac.", lines: 416, tests: 7 },
  ...
  { name: "wacc", what: "Porting the wac compiler to wac, so it can eventually compile itself.", lines: 22513, tests: 142 },
