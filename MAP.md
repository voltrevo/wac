...
39 packages, 125,215 lines of wac, 2494 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 29,751 | 218 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
