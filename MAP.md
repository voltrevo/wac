...
33 packages, 70,844 lines of wac, 1433 tests,
...
| [`fs`](packages/fs/) | A filesystem that belongs to the system rather than to the host. | 1,443 | 29 | `bytes` `fmt` `gzip` `platform` `std` |
