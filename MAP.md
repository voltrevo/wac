...
39 packages, 124,195 lines of wac, 2321 tests,
...
| [`wactest`](packages/wactest/) | Assertions for tests written in wac. | 552 | 17 | `bytes` `crypto` `fmt` `json` `platform` |
...
| [`wacpkg`](packages/wacpkg/) | Where a wac project says its dependencies come from: `wac.json5`, read and checked. | 727 | 20 | `bytes` `json` `wacc` |
