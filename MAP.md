...
39 packages, 135,020 lines of wac, 2785 tests,
...
| [`wac`](packages/wac/) | The command. | 2,528 | 0 | `fmt` `fs` `json` `wacc` `wacpkg` |
...
| `packages/wac/example/wac.wac` | `wac` — the command, as a program. |
