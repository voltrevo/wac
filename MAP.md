...
39 packages, 124,752 lines of wac, 2353 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 29,544 | 214 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
