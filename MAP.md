...
38 packages, 129,299 lines of wac, 2537 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 33,944 | 259 | `bytes` `codec` `crypto` `fmt` `fs` `wacpkg` |
