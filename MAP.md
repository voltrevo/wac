...
35 packages, 102,984 lines of wac, 1780 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 20,997 | 117 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
