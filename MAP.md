...
37 packages, 113,911 lines of wac, 2006 tests,
...
| [`webrtc`](packages/webrtc/) | WebRTC in wac — the data channel half, following `design/system/0008`. | 2,676 | 51 | `crypto` `fmt` `gzip` `tls` |
