...
38 packages, 122,072 lines of wac, 2228 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 28,995 | 210 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
