...
38 packages, 130,886 lines of wac, 2555 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 34,537 | 266 | `bytes` `codec` `crypto` `fmt` `fs` `wacpkg` |
