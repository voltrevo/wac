...
37 packages, 114,318 lines of wac, 2023 tests,
...
| [`webrtc`](packages/webrtc/) | WebRTC in wac — the data channel half, following `design/system/0008`. | 3,083 | 68 | `crypto` `fmt` `gzip` `tls` |
