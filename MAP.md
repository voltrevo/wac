...
39 packages, 125,492 lines of wac, 2500 tests,
...
| [`wacpkg`](packages/wacpkg/) | Where a wac project says its dependencies come from: `wac.json5`, read and checked. | 1,292 | 40 | `bytes` `fmt` `json` `platform` `wacc` |
