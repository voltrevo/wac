...
35 packages, 102,038 lines of wac, 1764 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 20,517 | 111 | `bytes` `codec` `crypto` `fmt` `platform` |
