...
38 packages, 131,312 lines of wac, 2612 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 34,831 | 290 | `bytes` `codec` `crypto` `fmt` `fs` `wacpkg` |
