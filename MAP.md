...
38 packages, 128,706 lines of wac, 2541 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 33,677 | 263 | `bytes` `codec` `crypto` `fmt` `fs` `wacpkg` |
