...
37 packages, 114,871 lines of wac, 2027 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 25,294 | 172 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
