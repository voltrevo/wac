...
37 packages, 115,152 lines of wac, 2029 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 25,427 | 173 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
