...
37 packages, 115,065 lines of wac, 2029 tests,
...
| [`webrtc`](packages/webrtc/) | WebRTC in wac — the data channel half, following `design/system/0008`. | 3,675 | 73 | `crypto` `fmt` `gzip` `platform` `tls` |
