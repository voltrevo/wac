...
37 packages, 115,166 lines of wac, 2030 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 25,441 | 174 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
