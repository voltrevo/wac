...
39 packages, 125,474 lines of wac, 2500 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 29,857 | 218 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
