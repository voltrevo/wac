...
37 packages, 114,584 lines of wac, 2023 tests,
...
| [`webrtc`](packages/webrtc/) | WebRTC in wac — the data channel half, following `design/system/0008`. | 3,349 | 68 | `crypto` `fmt` `gzip` `tls` |
