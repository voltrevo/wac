...
33 packages, 70,687 lines of wac, 1430 tests,
...
| [`fs`](packages/fs/) | A filesystem that belongs to the system rather than to the host. | 1,386 | 29 | `bytes` `fmt` `gzip` `platform` `std` |
