...
37 packages, 111,797 lines of wac, 1973 tests,
...
| [`webrtc`](packages/webrtc/) | WebRTC in wac — the data channel half, following `design/system/0008`. | 562 | 18 | `crypto` `fmt` `gzip` |
