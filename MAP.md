...
39 packages, 125,029 lines of wac, 2481 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 29,725 | 215 | `bytes` `codec` `crypto` `fmt` `fs` `platform` `std` |
