...
38 packages, 131,188 lines of wac, 2594 tests,
...
| [`wacc`](packages/wacc/) | Porting the wac compiler to wac, so it can eventually compile itself. | 34,768 | 288 | `bytes` `codec` `crypto` `fmt` `fs` `wacpkg` |
