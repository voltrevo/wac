...
`wac` is a C-family language that compiles to WebAssembly, its compiler, and a set of packages
written from scratch in it — including implementations of TLS 1.3, Tor, SSH, and a collection of
cryptographic primitives. It is a research project.

The compiler itself has not been audited either, and a miscompilation is a security property of
everything above it.
