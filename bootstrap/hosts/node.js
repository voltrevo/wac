...
if (isMain) {
  ...
  if (withWacc >= 0) {
    ...
    // something runnable — `design/system/0009` step 5. Off unless asked: it costs a second pass over
    // the program's exports, and the ladder's own builds do not need it.
    ...
    if (glueAt >= 0) await writeFile(args[glueAt + 1], glue);
    exit(0);
  }
