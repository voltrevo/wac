...
|---|---|---|---|
| [0116](open/0116-is-narrowing-does-not-choose-the-narrowed-types-method.md) | `is` narrowing does not choose the narrowed type's method, so an override is not called | bug | wrong answer |
