...
| [0001](open/0001-ternary-float-literal-f32.md) | a float literal in a ternary always types as f64 | bug | compile error |
...
16 issues, 13 of them found by porting wacc's AST to sum types and by probing shapes
