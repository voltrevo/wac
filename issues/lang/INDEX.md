...
|---|---|---|---|
| [0141](open/0141-a-lambda-cannot-be-passed-to-a-method.md) | a lambda cannot be passed to a method, only to a function or a constructor | missing feature | compile error |
