...
| [0103](open/0103-wacc-is-not-the-default-compiler-or-toolchain.md) | wacc is not the default compiler or toolchain: both halves swap under a flag and every package passes, but nothing does it without being told | missing feature | not implemented |
