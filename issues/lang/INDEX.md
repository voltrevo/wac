...
| [0108](open/0108-jsx-text-is-lexed-as-wac-so-an-apostrophe-ends-it.md) | JSX text is lexed as wac, so an apostrophe or a lone quote breaks the file | bug | compile error |
