...
|---|---|---|---|
| [0171a](open/0171a-unwrapping-a-nullable-primitive-loses-the-function.md) | `return x!;` on an `i32?` — or `i64?`, `f64?`, `bool?` — loses the whole function; a nullable *reference* unwraps fine | missing feature | the build fails and names the function |
