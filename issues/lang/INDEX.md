...
|---|---|---|---|
| [0095](open/0095-an-arm-binding-takes-its-type-from-a-same-named-variant-in-another-enum.md) | wacc: a `case` binding takes its type from a same-named variant in another enum | bug | compile error |
