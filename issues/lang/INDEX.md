...
|---|---|---|---|
| [0055](open/0055-arrays-have-no-bulk-copy-though-the-emitter-already-writes-one.md) | arrays have no bulk copy, though the emitter already writes one | missing feature | slow |
