...
|---|---|---|---|
| [0131](open/0131-the-blocked-walk-settles-a-different-env-than-the-emitter.md) | the blocked walk settles a different `Env` than the emitter, which is what 0090 was about | bug | wrong answer |
