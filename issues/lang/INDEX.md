...
|---|---|---|---|
| [0140](open/0140-a-wacc-only-syntax-cannot-appear-in-any-repository-file.md) | a wacc-only *syntax* cannot appear in any repository file | missing feature | not implemented |
