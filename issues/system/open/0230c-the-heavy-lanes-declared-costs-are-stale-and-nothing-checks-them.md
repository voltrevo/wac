...
| `packages/wacc/test/wac/programscompile_test.wac` | 42s | **42s** | accurate — re-measured 2026-08-30 when it moved to wac; the work is the compiling, so dropping the Deno bridge did not change it |
