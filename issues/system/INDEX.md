...
| [0098](open/0098-cryptos-coverage-run-has-68-uncovered-branches-and-nobody-sees-it.md) | crypto's coverage run has 45 uncovered branches, and nothing was looking | task | no error |
