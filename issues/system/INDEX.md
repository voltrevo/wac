...
|---|---|---|---|
| [0207](open/0207-a-dropped-receivefrom-ticket-leaves-a-reader-that-eats-the-next-datagram.md) | a dropped `receiveFrom` ticket leaves a reader blocked on the socket, and it takes the next datagram and discards it — mine, arriving with 0206's fix | bug | wrong answer |
