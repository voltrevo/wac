...
|---|---|---|---|
| [0150](open/0150-chromium-gathers-no-ice-candidates-in-this-container.md) | Chromium gathers no ICE candidates in this container, so browser interop stops at SDP | bug | not implemented |
