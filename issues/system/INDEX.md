...
|---|---|---|---|
| [0124](open/0124-waccs-float-literals-are-not-correctly-rounded-beyond-1e22.md) | wacc's float literals are not correctly rounded beyond ±1e22 | bug | wrong answer |
