...
| [0143](closed/0143-box-wc-counts-words-by-ascii-whitespace-only.md) | `box`'s `wc -w` splits on ASCII whitespace only, undercounting by 110 words on `spec/tour.wac` | correctness | wrong answer, no error |
