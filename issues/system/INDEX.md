...
|---|---|---|---|
| [0141](closed/0141-the-manifest-describes-structs-but-not-enum-variants.md) | the manifest describes structs but not enum variants, so every host hardcodes `$bind$e_<Bind>_<Variant>_new` | missing feature | **closed** |
