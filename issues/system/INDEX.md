...
|---|---|---|---|
| [0113](open/0113-a-pipeline-whose-first-stage-produces-nothing-hangs.md) | a pipeline whose first stage produces nothing hangs, if standard input is still open | bug | hangs |
