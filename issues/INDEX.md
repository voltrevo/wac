...
| [0034](open/0034-is-with-a-qualified-variant-name-is-always-false.md) | `s is Shape.Empty` is always false | bug | wrong answer |
| [0033](open/0033-unchecked-integer-overflow.md) | no way to detect integer overflow | missing feature | wrong answer |
| [0035](open/0035-generics.md) | generics | missing feature | not implemented |
...
21 issues, 18 of them found by porting wacc's AST to sum types and by probing shapes
