...
|---|---|---|---|
| [0072](open/0072-wacCompile-should-accept-parsed-programs-and-the-extension-should-select-a-frontend.md) | `wacCompile` should accept parsed programs, and the extension should select a frontend | missing feature | not implemented |
