...
> **Not vetted.** This is `../DECISIONS.md` as the packages exercise left it. It adds **no new rule**
> — 41 lines of annotation inside two of the three. See [README.md](README.md).
