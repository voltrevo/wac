...
> **Not vetted.** This is `../TECHNICAL.md` as the packages exercise left it: 37 entries against the
> vetted 34, with edits through the originals. See [README.md](README.md).
