...
`tools/specparse.ts` runs the result:
    ...
    deno run --allow-read tools/specparse.ts vision      # 56/56 files parse
...
of absences and cannot say whether the list is complete. A grammar that **accepts** all fifty-six
